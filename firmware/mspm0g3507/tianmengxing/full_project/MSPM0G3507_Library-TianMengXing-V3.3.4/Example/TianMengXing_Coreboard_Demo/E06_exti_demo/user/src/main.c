...
// **************************** 代码区域 ****************************
#define LED1                    (TMX_LED_PIN)

#define KEY1                    (TMX_KEY_PIN)                                          // 定义外部中断引脚1 
#define KEY2                    (A30)                                          // 定义外部中断引脚2 
#define KEY3                    (A31)                                           // 定义外部中断引脚3
#define KEY4                    (B0)                                           // 定义外部中断引脚4
...
int main (void)
{
    ...
    exti_init(KEY1, EXTI_TRIGGER_FALLING,key1_exti_handler,NULL);               // 初始化 KEY1 为外部中断输入 上升沿触发
