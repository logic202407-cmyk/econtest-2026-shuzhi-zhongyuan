...
#define GIMBAL_YAW_ONLY_DEADBAND_0P01DEG 250
...
#define GIMBAL_YAW_ONLY_SPEED_MAX_0P1_RPM 150
#define GIMBAL_YAW_ONLY_SPEED_MIN_0P1_RPM 30
#define GIMBAL_YAW_ONLY_SPEED_KP_NUM    1
#define GIMBAL_YAW_ONLY_SPEED_KP_DEN    10
#define GIMBAL_YAW_ONLY_SPEED_KD_NUM    1
#define GIMBAL_YAW_ONLY_SPEED_KD_DEN    30
#define GIMBAL_YAW_ONLY_SPEED_HYST_0P1_RPM 15
