...
#define GIMBAL_YAW_ONLY_MIN_0P1DEG      (-450)
#define GIMBAL_YAW_ONLY_MAX_0P1DEG      450
...
#define GIMBAL_YAW_ONLY_ACC_RPM_S       150U
#define GIMBAL_YAW_ONLY_SPEED_0P1_RPM   500U
#define GIMBAL_YAW_ONLY_SPEED_MODE      1U
#define GIMBAL_YAW_ONLY_SPEED_PERIOD_MS 40U
#define GIMBAL_YAW_ONLY_SPEED_MAX_0P1_RPM 300
#define GIMBAL_YAW_ONLY_SPEED_MIN_0P1_RPM 50
#define GIMBAL_YAW_ONLY_SPEED_KP_NUM    3
#define GIMBAL_YAW_ONLY_SPEED_KP_DEN    10
#define GIMBAL_YAW_ONLY_SPEED_KD_NUM    2
#define GIMBAL_YAW_ONLY_SPEED_KD_DEN    25
#define GIMBAL_YAW_ONLY_SPEED_HYST_0P1_RPM 20
