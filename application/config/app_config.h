...
#define GIMBAL_YAW_ONLY_PERIOD_MS       100U
#define GIMBAL_YAW_ONLY_MIN_0P1DEG      (-600)
#define GIMBAL_YAW_ONLY_MAX_0P1DEG      600
#define GIMBAL_YAW_ONLY_STEP_LIMIT_0P1DEG 20
#define GIMBAL_YAW_ONLY_DEADBAND_0P01DEG 80
#define GIMBAL_YAW_ONLY_CONF_MIN_0P01PCT 5000U
#define GIMBAL_YAW_ONLY_KP_NUM          1
#define GIMBAL_YAW_ONLY_KP_DEN          4
#define GIMBAL_YAW_ONLY_FILTER_SHIFT    2U
