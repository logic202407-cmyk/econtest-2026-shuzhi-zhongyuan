...
#define GIMBAL_YAW_ONLY_CONF_MIN_0P01PCT 6000U
#define GIMBAL_YAW_ONLY_CONF_START_MIN_0P01PCT 6500U
...
#define GIMBAL_YAW_ONLY_ACC_RPM_S       80U
#define GIMBAL_YAW_ONLY_SPEED_0P1_RPM   500U
#define GIMBAL_YAW_ONLY_SPEED_MODE      1U
#define GIMBAL_YAW_ONLY_SPEED_PERIOD_MS 40U
#define GIMBAL_YAW_ONLY_SPEED_MAX_0P1_RPM 180
#define GIMBAL_YAW_ONLY_SPEED_MIN_0P1_RPM 12
#define GIMBAL_YAW_ONLY_SPEED_KP_NUM    1
#define GIMBAL_YAW_ONLY_SPEED_KP_DEN    8
#define GIMBAL_YAW_ONLY_SPEED_KD_NUM    1
#define GIMBAL_YAW_ONLY_SPEED_KD_DEN    8
#define GIMBAL_YAW_ONLY_SPEED_HYST_0P1_RPM 8
#define GIMBAL_YAW_ONLY_SPEED_STEP_0P1_RPM 25
