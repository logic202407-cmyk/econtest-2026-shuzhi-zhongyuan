...
static void test_x42s_frames(void)
{
    ...
    const uint8_t speed_expected[] = {
        0x02U, 0xF6U, 0x01U, 0x00U, 0x64U, 0x00U, 0x19U, 0x00U, 0x6BU
    };
    const uint8_t request_speed_expected[] = {0x02U, 0x0EU, 0x6BU};
    const uint8_t request_position_expected[] = {0x02U, 0x0FU, 0x6BU};
    const uint8_t speed_reply[] = {0x02U, 0x0EU, 0x01U, 0x00U, 0xFAU, 0x6BU};
    const uint8_t position_reply[] = {
        0x02U, 0x0FU, 0x00U, 0x00U, 0x00U, 0x03U, 0x84U, 0x6BU
    };
    size_t index;
